...
|---|---|---|---|
|WORK|현위치 설정안되는 오류 수정, 값을 입력하지 않고 넘어갔을 경우 알림 주기, 이전 창으로 돌아갔을 때 전부 비워지지 않고 기존에 입력했던 값 불러올 수 있게, 위도경도가 아닌 지도정보값으로 위치 알려주기|현위치 설정안되는 오류 수정, 값을 입력하지 않고 넘어갔을 경우 알림 주기, 이전 창으로 돌아갔을 때 전부 비워지지 않고 기존에 입력했던 값 불러올 수 있게|위도경도가 아닌 지도정보값으로 위치 알려주기, 지도 위치 카카오톡 공유 구현, 초대 링크 복사 구현, 초대 카카오톡 공유 구현|
